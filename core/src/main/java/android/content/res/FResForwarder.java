...
/**
 * Instances of this class can be used for {@link FResources#setReplacement(String, String, String, Object)}
 ...
 *
 * <p>Usually, instances aren't created directly but via {@link FModuleResources#fwd}.
 */
public class FResForwarder {
	 ...
	 */
	public FResForwarder(Resources res, int id) {
		this.res = res;
		this.id = id;
	}
